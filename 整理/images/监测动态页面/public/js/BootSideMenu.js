...
(function ($) {
    ...
    $.fn.BootSideMenu = function (userOptions) {
        ...
        if (options.side == "left") {
        	 newCode += "	<span class=\"glyphicon\" style=\"width:20px;\"><br /><br />创建快报</span>";     
        } else if (options.side == "right") {
        	 newCode += "	<span class=\"glyphicon\" style=\"width:20px;\"><br /><br />更多文章</span>";
        }
        ...
        function startDefault() {
            if (options.side == "left") {
                if (options.autoClose) {
                    ...
                    menu.status = "opened";
                    if (options.pushBody) {
                        $("body").css("margin-left", menu.width() + 50);
                    }
                }
            } else if (options.side == "right") {
                if (options.autoClose) {
                    ...
                    menu.status = "opened";
                    if (options.pushBody) {
                        $("body").css("margin-right", menu.width() + 50);
                    }
                }
            }
        }
        ...
        function openMenu(execFunctions) {
            ...
            if (options.side == "left") {
                ...
                if (options.pushBody) {
                    $("body").animate({marginLeft: menu.width() + 50}, {duration: options.duration});
                }
