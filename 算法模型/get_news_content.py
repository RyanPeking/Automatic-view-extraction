...
if __name__ == '__main__':
    ...
    with open(r'D:\Github_project\Project_one\算法模型\data\news_civilization_add_opinion_drop_duplicates.pk', 'rb') as f:
    ...
    with open(r'D:\Github_project\Project_one\算法模型\data\news_economy_add_opinion_drop_duplicates.pk', 'rb') as f:
    ...
    with open(r'D:\Github_project\Project_one\算法模型\data\news_education_add_opinion_drop_duplicates.pk', 'rb') as f:
    ...
    with open(r'D:\Github_project\Project_one\算法模型\data\news_military_add_opinion_drop_duplicates.pk', 'rb') as f:
    ...
    with open(r'D:\Github_project\Project_one\算法模型\data\news_other_add_opinion_drop_duplicates.pk', 'rb') as f:
    ...
    with open(r'D:\Github_project\Project_one\算法模型\data\news_polity_add_opinion_drop_duplicates.pk', 'rb') as f:
    ...
    with open(r'D:\Github_project\Project_one\算法模型\data\news_society_add_opinion_drop_duplicates.pk', 'rb') as f:
